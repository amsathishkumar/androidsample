...
public class MyContentProvider extends ContentProvider {
	...
	private static final String contentTypeMultiple = "nd.android.cursor.dir/myContentProvider.data.text";
	...
	public synchronized int update(Uri uri, ContentValues values, String selection,
		...
		throw new UnsupportedOperationException("I was too lazy to implement this!");
	}
